...
class AddExtraInformationYesNoViewSpec extends YesNoViewBehaviours {
  ...
  override def applyView(form: Form[Boolean]): HtmlFormat.Appendable =
    injector.instanceOf[AddExtraInformationYesNoView].apply(form, departureId, NormalMode)(fakeRequest, messages)

  override val prefix: String = "loading.addExtraInformationYesNo"
