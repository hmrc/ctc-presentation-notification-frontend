        ...
        "when locationType undefined" in {
          forAll(arbitrary[Mode]) {
            mode =>
              ...
              val helper = new LocationOfGoodsAnswersHelper(ie015WithNoUserAnswers, departureId, refDataLocationTypes, identifications, mode)
        ...
        s"when LocationTypePage defined in the ie170" in {
          forAll(arbitrary[Mode], arbitrary[LocationType]) {
            (mode, locationType) =>
              ...
              val helper = new LocationOfGoodsAnswersHelper(answers, departureId, refDataLocationTypes, identifications, mode)
              val result = helper.locationType
        ...
        "when LocationTypePage defined in ie15" in {
          forAll(arbitrary[Mode], Gen.oneOf(locationTypes)) {
            (mode, locationType) =>
              ...
              val helper = new LocationOfGoodsAnswersHelper(ie015UserAnswers, departureId, refDataLocationTypes, identifications, mode)
              val result = helper.locationType
        ...
        "when AuthorisationNumberPage defined in ie15" in {
          forAll(arbitrary[Mode]) {
            mode =>
              ...
              val helper                                  = new LocationOfGoodsAnswersHelper(ie015WithAuthorisationNumberUserAnswers, departureId, refDataLocationTypes, identifications, mode)
              val result                                  = helper.authorisationNumber
