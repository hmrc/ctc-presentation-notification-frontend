...
class AddDepartureTransportMeansYesNoControllerSpec extends SpecBase with AppWithDefaultMockFixtures {
  ...
  "AddDepartureTransportMeansYesNoController Controller" - {
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      val request = FakeRequest(POST, addDepartureTransportMeansRoute)
    ...
    "must return a Bad Request and errors when invalid data is submitted" in {
      ...
      val request    = FakeRequest(POST, addDepartureTransportMeansRoute).withFormUrlEncodedBody(("value", ""))
