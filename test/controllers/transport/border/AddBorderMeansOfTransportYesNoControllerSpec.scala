...
class AddBorderMeansOfTransportYesNoControllerSpec extends SpecBase with AppWithDefaultMockFixtures with MockitoSugar {

  private val formProvider                            = new YesNoFormProvider()
  private val form                                    = formProvider("transport.border.addBorderMeansOfTransportYesNo")
  private val mode                                    = NormalMode
  private lazy val addBorderModeOfTransportYesNoRoute = borderRoutes.AddBorderMeansOfTransportYesNoController.onPageLoad(departureId, mode).url
