...
class NationalityControllerSpec extends SpecBase with AppWithDefaultMockFixtures with Generators {
  ...
  private val form         = formProvider("transportMeans.nationality", nationalityList)
  private val mode         = NormalMode

  private val mockNationalitiesService: NationalitiesService = mock[NationalitiesService]
  private lazy val nationalityRoute                          = controllers.transportMeans.routes.NationalityController.onPageLoad(departureId, mode, index).url
