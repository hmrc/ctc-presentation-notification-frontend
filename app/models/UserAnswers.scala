...
object UserAnswers {
  ...
  private val departureTransportMeansConsignmentLens: Lens[Consignment, Option[List[DepartureTransportMeans]]] =
  ...
  val setDepartureTransportMeansAnswersLens: Lens[UserAnswers, Option[List[DepartureTransportMeans]]] =
