...
package controllers.transitOperation
...
class AddArrivalDateYesNoController @Inject() (
  ...
  //TODO: Change annotation when transitOperation navigator added
  ...
  private val form = formProvider("transitOperation.addArrivalDateYesNo")
  ...
  private def redirect(
    ...
    } yield Redirect(navigator.nextPage(AddArrivalDateYesNoPage, updatedAnswers, departureId, mode))
}
